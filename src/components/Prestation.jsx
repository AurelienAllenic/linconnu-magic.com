                ...
                <Parallax className='img' bgImage={PrestationIMG} strength={800}>
                    ...
                    <ContainerPrestation>
                        <CardPrestation>
                            ...
                            <ContentCard>Qu'il s'agisse de <Important>Scène</Important> ou de <Important>Close-Up</Important> (table en table), il est possible de réaliser une prestation en <Important>Ile-de-France</Important> de préférence.</ContentCard><ContentCard>Si elle a lieu ailleurs, merci de le préciser afin d'étudier les modalités de l'évènement.</ContentCard>
                            <ContentCard>Pour tout type d'évènement, il est possible de <ContactClass><Link to='contact' spy={true} smooth={true} offset={0} duration={500}>réserver une soirée, une journée</Link></ContactClass>.</ContentCard>
